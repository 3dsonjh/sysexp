$(function() { // ou $(document).ready(function(){
    ...
    $("#btn-carregar").click(function(){
        ...
        $.getJSON(url+"/641cebb6ac3dc7f11a08ae3a",function(dados){
            console.log(dados);
            $("#nota").val(dados.nota);
